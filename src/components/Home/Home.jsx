      ...
      <div className="subsection">
        ...
        <div>
          <img
            ...
            src="https://res.cloudinary.com/ferjen/image/upload/v1681958286/yeah_stretching/profe/img-prof-01_z5v5xg.png"
            alt=""
          />
        </div>
      </div>
      <div>
        <div className="hero__title">
          ...
          <h5>
            ...
            para seguir activos y en movimiento, cuidando la salud de nuestro
            cuerpo y nuestra mente, desde el hogar
          </h5>
          <h5>
            <span className="text__highlight">
              ¡Todos podemos y debemos hacer ejercicio!
            </span>
          </h5>
